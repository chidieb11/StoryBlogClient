        ...
        <div>
            ...
            <div className="container">
                <div className="settingsCard">
                    <label className="user" htmlFor="user">update your information</label>
                    <form className="settingsForm" action="">
                        ...
                        <input type="text" placeholder="username" className="settingUsername"/>
                    </form>
                    <span className="settingsSpan">
                        ...
                        <input type="file" id="picUpdate" className="profilePic" style={{display: "none"}}/>
                    </span>
